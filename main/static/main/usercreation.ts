...
const trackerSelected = $("#trackerSelected");
const trackerAll = $("#trackerAll");

$("#bttnAdd").on("click", () => {
    $("#trackerAll option:selected").each((i, ele) => {
        let element = $(ele);
...
$("#bttnRemove").on("click", () => {
    trackerSelected.find("option:selected").each((i, ele) => {
        let element = $(ele);
...
$("#myForm").on("submit", () => {
    let values = [];
    trackerSelected.find("option").each((i, ele) => {
        let element = $(ele);
